<template>
  <div class="range-number-wrapper">
    <a-input-number v-model="startValue" :placeholder="placeholder[0]" />
    <slot><span class="seperator">~</span></slot
    ><a-input-number v-model="endValue" :placeholder="placeholder[1]" />
  </div>
</template>
<script>
export default {
